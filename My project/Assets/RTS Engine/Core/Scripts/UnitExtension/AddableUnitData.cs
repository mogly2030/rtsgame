...
{
    public enum CarriableUnitOtherFactionBehaviour {none, allowEnterFreeCarrier, allowEnterOtherFactionCarrier, allowAll }

    [System.Serializable]
    public struct AddableUnitData
    {
        public CarriableUnitOtherFactionBehaviour otherFactionBehaviour;
        ...
        public AddableUnitData (
            ...
            bool playerCommand,
            CarriableUnitOtherFactionBehaviour otherFactionBeahviour = CarriableUnitOtherFactionBehaviour.none,
            bool isMoveAttackRequest = false)
        { 
            this.otherFactionBehaviour = otherFactionBeahviour;
