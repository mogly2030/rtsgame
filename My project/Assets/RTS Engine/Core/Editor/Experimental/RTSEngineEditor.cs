...
namespace RTSEngine.EditorOnly
{
    ...
    public class RTSEngineEditor : EditorWindow
    {
        ...
        {
            UnityEngine.UIElements.Box navigationBox = rootVisualElement.Query<UnityEngine.UIElements.Box>("navigation-box").First();
            navigationBox.Clear();
        ...
        private void DisableSelection()
        {
            ...
            var elementPropsBox = rootVisualElement.Query<UnityEngine.UIElements.Box>("element-properties-box").First();
        ...
        private void HandleSelectionChanged(List<object> obj)
        {
            ...
            var elementBox = rootVisualElement.Query<UnityEngine.UIElements.Box>("element-box").First();

            var elementTitleBox = rootVisualElement.Query<UnityEngine.UIElements.Box>("element-title-box").First();
        ...
        private void OnRightSideBarUI()
        {
            ...
            var rightSideBoxTop = rootVisualElement.Query<UnityEngine.UIElements.Box>("right-sidebox-top").First();
            rightSideBoxTop.Clear();
            var rightSideBoxBottom = rootVisualElement.Query<UnityEngine.UIElements.Box>("right-sidebox-bottom").First();
